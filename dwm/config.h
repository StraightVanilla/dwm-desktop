...
static const char dmenufont[]       = "Victor Mono:size=14:antialias=true:autohint:true";

#include "colors/catppuccin-macchiato.h"

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm]     = { col_gray3, col_gray1, col_gray1 },
	[SchemeSel]      = { col_gray3, col_gray1, col_cyan  },
	[SchemeStatus]   = { col_gray1, col_gray1,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
